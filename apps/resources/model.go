...
type Resource struct {
	...
	ResourceHostIP      string `gorm:"column:resource_host_ip" json:"resource_host_ip" form:"resource_host_ip"`
	...
	ResourcePort        string `gorm:"type:varchar(32);column:resource_port" json:"resource_port" form:"resource_port" binding:"required"`
...
type ResourceType struct {
	ResourceTypeID          int    `gorm:"column:resource_id;primary_key" json:"resource_id" form:"resource_id"`
	ResourceParentTypeID    int    `gorm:"column:resource_parent_id;default:0" json:"resource_parent_id" form:"resource_parent_id"`
	ResourceTypeName        string `gorm:"type:varchar(32);column:resource_type_name;unique;not null" json:"resource_type_name" form:"resource_type_name" binding:"required"`
	ResourceTypeDescription string `gorm:"type:varchar(32);column:resource_type_description;unique;not null" json:"resource_type_description" form:"resource_type_description" binding:"required"`
}
