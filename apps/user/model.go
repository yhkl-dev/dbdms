...
type User struct {
	...
	UserName     string `gorm:"type:varchar(32);column:user_name;unique;not null" json:"user_name" form:"user_name" binding:"required"`
	UserPhone    string `gorm:"type:varchar(32);column:user_phone;unique;not null" json:"user_phone" form:"user_phone" binding:"required"`
	...
	UserEmail    string `gorm:"type:varchar(64);column:user_email;unique" json:"user_email" form:"user_email"`
}
